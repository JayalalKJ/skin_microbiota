...
After collection:
Swabs were placed immediately in 96% ethanol.
Samples were kept on ice during transport.
...
Sequence processing was based on the mothur MiSeq SOP, adapted to the characteristics of this dataset.
The main workflow comprised:
Adapter and primer removal using Cutadapt
Quality filtering of raw reads
Paired-end read merging using FLASH
Processing of cleaned reads using mothur
Alignment against a tailored SILVA V3–V4 reference alignment
Chimera detection and removal
Taxonomic classification
Removal of non-bacterial and other unwanted lineages
OTU construction and filtering
Assessment of extraction blanks and negative controls
Removal of potential contaminants
Rarefaction and alpha-diversity analysis
Beta-diversity, ordination, PERMANOVA, and PERMDISP analysis
Taxonomic composition analysis and visualisation in R
...
Review and update file paths in `00_project_setup.R`.
Confirm that all required input files are available.
Install the required R packages and command-line dependencies.
Confirm that sample identifiers and metadata columns match those expected by the scripts.
Set or record random seeds for analyses involving permutation or stochastic procedures.
...
Data Availability
The 16S rRNA gene V3–V4 amplicon sequencing data generated in this study are deposited in the European Nucleotide Archive:
BioProject accession: `PRJEB83870`
Study accession: `ERP167439`
Open Science Statement
This repository is made openly available in accordance with the open science principles of UiT – The Arctic University of Norway and the Data Management Plan established for this PhD project.
...
The associated research article once its final citation and DOI are available.
The archived release of this repository once a DOI has been assigned.
The principal software and workflow publications relevant to the reused analysis.
...
Muninbakken 21  
9019 Tromsø, Norway
Email: jayalal.p.kalathil@uit.no
